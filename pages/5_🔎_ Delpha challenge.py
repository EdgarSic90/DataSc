...
st.write("""
         In this [/DELPHA Github Repository](https://github.com/EdgarSic90/DataSc/tree/master/DELPHA) 
         ...
         """)
st.write("""
             In this [/pages Github Repository](https://github.com/EdgarSic90/DataSc/tree/master/pages) 
